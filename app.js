 ...
 $(document).ready(function () {
     ...
     $("#add-rapper").on("click", function (event) {
         ...
         //when the user hits submit, the new input is being added to the array topics, but the submit button is also calling 
         //the giphy api and returning 10 random gifs, i could not figure out where to prevent this
